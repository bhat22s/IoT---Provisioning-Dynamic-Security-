...
def demo_aead(variant, message, ad):
    assert variant in ["Ascon-128", "Ascon-128a", "Ascon-80pq"]
    ...
    start = time.time()
    ciphertext        = ascon_encrypt(key, nonce, ad, message,  variant)
    end = time.time()
    start2 = time.time()
    ...
    print("EncryptionTime: ", end - start)
    print("DecryptionTime: ", end2 - start2)
...
if __name__ == "__main__":
    message = b"liaqbpxxlhqvboaywjxjnqnbaoqaomhl"
    ad = b"liaqbpxxlhqvboaywjxjnqnbaoqaomhl"
    demo_aead("Ascon-128a", message, ad)
    demo_aead("Ascon-128", message, ad)
    demo_aead("Ascon-80pq", message, ad)
    message2 = b"licfumnlvebfmdpfjdacztrcjnqcuhvlhxwljkmiebirzfpafoployzyfgbgmncseepivjirpuivhxzfcghrfistfgedpdvzksmnrwmfxkfhhpafmxcrxrvmewcosoedidwwasgkiihkyxzsevhizwk"
    ad2 = b"icfumnlvebfmdpfjdacztrcjnqcuhvlhxwljkmiebirzfpafoployzyfgbgmncseepivjirpuivhxzfcghrfistfgedpdvzksmnrwmfxkfhhpafmxcrxrvmewcosoedidwwasgkiihkyxzsevhizwk"
    demo_aead("Ascon-128a", message2, ad2)
    demo_aead("Ascon-128", message2, ad2)
    demo_aead("Ascon-80pq", message2, ad2)
    message3 = b""
    ad3 = b""
    demo_aead("Ascon-128a", message3, ad3)
    demo_aead("Ascon-128", message3, ad3)
    demo_aead("Ascon-80pq", message3, ad3)
