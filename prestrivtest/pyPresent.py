...
def string2number(i):
    ...
    if type(i) == bytes:
        ...
        bytes_i = codecs.encode(i, "utf-8")
        return int(bytes_i.hex(), 16)
    elif type(i) == int:
        return i
    else:
        raise TypeError("Expected str and bytes")
...
if __name__ == "__main__":
    #lines 220-224 retrieved from u/Niklas from https://stackoverflow.com/questions/3283984/decode-hex-string-in-python-3/3284069
    ...
    enc_1 = codecs.encode(encrypted_1, "hex").decode('utf-8')
    enc_2 = codecs.encode(encrypted_2, "hex").decode('utf-8')
    enc_3 = codecs.encode(encrypted_3, "hex").decode('utf-8')
    print(enc_1)
    print(enc_2)
    print(enc_3)
